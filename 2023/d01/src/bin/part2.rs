...
pub fn main() -> Result<()> {
    // let file = File::open("src/sample2").unwrap();
    ...
    for line in reader.lines() {
        ...
        text_to_num.insert("zero", 0);
        text_to_num.insert("one", 1);
        text_to_num.insert("two", 2);
        text_to_num.insert("three", 3);
        text_to_num.insert("four", 4);
        text_to_num.insert("five", 5);
        text_to_num.insert("six", 6);
        text_to_num.insert("seven", 7);
        text_to_num.insert("eight", 8);
        text_to_num.insert("nine", 9);
